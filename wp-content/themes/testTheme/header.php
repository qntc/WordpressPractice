  ...
  <header class="site-header">
    <div class="container">
      ...
      <div class="site-header__menu group">
        ...
        <ul>
            <li <?php if (is_page('approach') or wp_get_post_parent_id( 0 ) == 60) echo 'class="current-menu-item"'?>><a href="<?php echo site_url('/approach');?>">About Us</a></li>
            <li <?php if (get_post_type() == 'program') echo 'class="current-menu-item"'?>><a href="<?php echo get_post_type_archive_link( 'program' ); ?>">Courses</a></li>
