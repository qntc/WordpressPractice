...
if ( get_field('header_image') ) {
	...
	$bodyClassAdd = 'no-top-pad project';
...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner" style="background-image:url('<?php the_field('header_image') ?>'); ">
		...
		<?php 
			...
			$logo_style = get_field( 'menu_style' );
...
<div class="instagram">	<a href="https://www.instagram.com/clearspacedesign/" target="_blank">Instagram</a></div>
    ...
    <div class="row">
      ...
      <div class="span4"><?php if (get_field('header_centered_logo')) { ?><img id="headerlogo" class="img-responsive center-block" src="<?php the_field('header_centered_logo') ?>" /><?php } ?></div>
...
<?php /*
<!-- <img id="headerlogo" class="img-responsive" src="<?php the_field('header_centered_logo') ?>"> -->
*/ ?>
	</header><!-- #masthead -->
